...
public class ProcesoDeposito extends Thread implements Configurable{
	
	private CuentaDAO cuentaDAO;
	private ViewMain viewMain;
	private Cuenta cuenta;
	
	public ProcesoDeposito(ViewMain viewMain) {
	...
	public void run() {
		...
		if (encontrado) {
			if (Double.parseDouble(viewMain.textFieldMonto.getText())>0.0) {
